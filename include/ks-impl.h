...
#define KST_NUM_OPKVS(_type) \
    ...
    {"__mul__",          (ks_obj)ks_cfunc_new_c(_type##_mul##_, #_type ".__mul__(L, R)")}, \
    {"__div__",          (ks_obj)ks_cfunc_new_c(_type##_div##_, #_type ".__div__(L, R)")}, \
    {"__mod__",          (ks_obj)ks_cfunc_new_c(_type##_mod##_, #_type ".__mod__(L, R)")}, \
    {"__pow__",          (ks_obj)ks_cfunc_new_c(_type##_pow##_, #_type ".__pow__(L, R)")}, \
    ...
    {"__le__",          (ks_obj)ks_cfunc_new_c(_type##_le##_, #_type ".__le__(L, R)")}, \
    {"__ge__",          (ks_obj)ks_cfunc_new_c(_type##_ge##_, #_type ".__ge__(L, R)")}, \
    {"__eq__",          (ks_obj)ks_cfunc_new_c(_type##_eq##_, #_type ".__eq__(L, R)")}, \
